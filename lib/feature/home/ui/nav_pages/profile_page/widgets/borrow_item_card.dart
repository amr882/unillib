...
class BorrowItemCard extends StatefulWidget {
  final String userId;
  ...
  @override
  State<BorrowItemCard> createState() => _BorrowItemCardState();
}

class _BorrowItemCardState extends State<BorrowItemCard> {
  Book? _book;
  ...
  @override
  void didUpdateWidget(covariant BorrowItemCard oldWidget) {
